...
{
  TTS_EQUAL(  kwk::shape{3}       ,  kwk::shape{3}        );
  TTS_EQUAL(  kwk::shape{3}       , (kwk::shape{3,1})     );
  TTS_EQUAL(  kwk::shape{3}       , (kwk::shape{3,1,1})   );
  TTS_EQUAL(  kwk::shape{3}       , (kwk::shape{3,1,1,1}) );

  TTS_EQUAL( (kwk::shape{3,5})    , (kwk::shape{3,5})     );
  TTS_EQUAL( (kwk::shape{3,5})    , (kwk::shape{3,5,1})   );
  TTS_EQUAL( (kwk::shape{3,5})    , (kwk::shape{3,5,1,1}) );

  TTS_EQUAL( (kwk::shape{3,5,7})  , (kwk::shape{3,5,7})   );
  TTS_EQUAL( (kwk::shape{3,5,7})  , (kwk::shape{3,5,7,1}) );

  TTS_EQUAL( (kwk::shape{3,5,7,9}), (kwk::shape{3,5,7,9}) );
...
{
  TTS_NOT_EQUAL(  kwk::shape{3}       ,  kwk::shape{7}        );
  TTS_NOT_EQUAL(  kwk::shape{3}       , (kwk::shape{3,2})     );
  TTS_NOT_EQUAL(  kwk::shape{3}       , (kwk::shape{3,2,4})   );
  TTS_NOT_EQUAL(  kwk::shape{3}       , (kwk::shape{3,3,5,7}) );

  TTS_NOT_EQUAL( (kwk::shape{3,5})    , (kwk::shape{7})       );
  TTS_NOT_EQUAL( (kwk::shape{3,5})    , (kwk::shape{3,7})     );
  TTS_NOT_EQUAL( (kwk::shape{3,5})    , (kwk::shape{3,5,7})   );
  TTS_NOT_EQUAL( (kwk::shape{3,5})    , (kwk::shape{3,5,7,9}) );

  TTS_NOT_EQUAL( (kwk::shape{3,5,7})  , (kwk::shape{3})       );
  TTS_NOT_EQUAL( (kwk::shape{3,5,7})  , (kwk::shape{3,5})     );
  TTS_NOT_EQUAL( (kwk::shape{3,5,7})  , (kwk::shape{3,5,9})   );
  TTS_NOT_EQUAL( (kwk::shape{3,5,7})  , (kwk::shape{3,5,7,9}) );

  TTS_NOT_EQUAL( (kwk::shape{3,5,7,9}), (kwk::shape{3})        );
  TTS_NOT_EQUAL( (kwk::shape{3,5,7,9}), (kwk::shape{3,5})      );
  TTS_NOT_EQUAL( (kwk::shape{3,5,7,9}), (kwk::shape{3,5,7})    );
  TTS_NOT_EQUAL( (kwk::shape{3,5,7,9}), (kwk::shape{3,5,7,2})  );
