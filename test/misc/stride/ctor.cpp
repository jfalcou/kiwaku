...
TTS_CASE( "Building a 1D stride from a shape" )
{
  kwk::shape  sh{422};
  kwk::stride st{sh};
...
TTS_CASE( "Building a 2D stride from a shape" )
{
...
TTS_CASE( "Building a 3D stride from a shape" )
{
...
TTS_CASE( "Building a 4D stride from a shape" )
{
