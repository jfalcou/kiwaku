...
TTS_CASE("Check for kwk::all_of(kwk::cpu, in, func) 2D")
{
  using data_type = int;
...
TTS_CASE("Check for kwk::all_of(kwk::cpu, in, func) 2D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::any_of(kwk::cpu, in, func) 2D true")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::any_of(kwk::cpu, in, func) 2D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::none_of(kwk::cpu, in, func) 2D true")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::none_of(kwk::cpu, in, func) 2D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::count(kwk::cpu, in, value) 2D")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::count_if(kwk::cpu, in, func) 2D")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
