...
TTS_CASE("Check for kwk::all_of(kwk::cpu, in, func) 1D")
{
  using data_type = int;
...
TTS_CASE("Check for kwk::all_of(kwk::cpu, in, func) 1D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t input_size = d0;
...
TTS_CASE("Check for kwk::any_of(kwk::cpu, in, func) 1D true")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t input_size = d0;
...
TTS_CASE("Check for kwk::any_of(kwk::cpu, in, func) 1D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t input_size = d0;
...
TTS_CASE("Check for kwk::none_of(kwk::cpu, in, func) 1D true")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t input_size = d0;
...
TTS_CASE("Check for kwk::none_of(kwk::cpu, in, func) 1D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t input_size = d0;
...
TTS_CASE("Check for kwk::count(kwk::cpu, in, value) 1D")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t input_size = d0;
...
TTS_CASE("Check for kwk::count_if(kwk::cpu, in, func) 1D")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t input_size = d0;
