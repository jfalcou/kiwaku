...
TTS_CASE("Check for kwk::all_of(in, func) 4D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::any_of(in, func) 4D true")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::any_of(in, func) 4D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::none_of(in, func) 4D true")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
...
TTS_CASE("Check for kwk::none_of(in, func) 4D false")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
