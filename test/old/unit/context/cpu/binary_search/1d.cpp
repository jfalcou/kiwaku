...
TTS_CASE("Check for kwk::lower_bound(kwk::cpu, In, value) 1D")
{
  ...
  // Valid values
  {
    ...
    TTS_ALL_EQUAL(*kwk::lower_bound(kwk::cpu, view, search), (std::array<std::size_t, 1>{expected}));
    TTS_EQUAL ((*kwk::lower_bound(kwk::cpu, view, search))[0]
  ...
  {
    int search = 20;
    TTS_EQUAL(kwk::lower_bound(kwk::cpu, view, search), std::nullopt);
...
TTS_CASE("Check for kwk::lower_bound(kwk::cpu, In, value, func) 1D with function")
{
  const std::size_t input_size = 20;
  std::array<int, input_size> input;
  ...
  // Valid values
  {
    ...
    TTS_ALL_EQUAL(*kwk::lower_bound(kwk::cpu, view, search, func), r);
    /*Compare with std implementation: compare found indexes*/
    TTS_EQUAL ( (*kwk::lower_bound(kwk::cpu, view, search, func))[0]
  ...
  {
    int search = 20;
    TTS_EQUAL(kwk::lower_bound(kwk::cpu, view, search, func), std::nullopt);
...
TTS_CASE("Check for kwk::lower_bound 1D: size 0 with CPU context")
{
...
TTS_CASE("Check for kwk::upper_bound(kwk::cpu, In, value) 1D")
{
  const std::size_t input_size = 20;
  std::array<int, input_size> input;
  for (std::size_t i = 0; i < input_size; ++i) { input[i] = i; }
  ...
  // upper_bound returns the index of the first element above the specified value
  {
    ...
    /*Compare values*/
    std::array<std::size_t, 1> r{expected};
    TTS_ALL_EQUAL(*kwk::upper_bound(kwk::cpu, view, search), r);
    /*Compare with std implementation*/
    TTS_EQUAL ( (*kwk::upper_bound(kwk::cpu, view, search))[0]
  ...
  {
    int search = 19;
    TTS_EQUAL(kwk::upper_bound(kwk::cpu, view, search), std::nullopt);
...
TTS_CASE("Check for kwk::upper_bound(kwk::cpu, In, value) 1D with function")
{
  const std::size_t input_size = 20;
  std::array<int, input_size> input;
  ...
  // upper_bound returns the index of the first element above the specified value
  {
    ...
    /*Compare values*/
    std::array<std::size_t, 1> r{expected};
    TTS_ALL_EQUAL(*kwk::upper_bound(kwk::cpu, view, search, func), r);
    /*Compare with std implementation*/
    TTS_EQUAL ( (*kwk::upper_bound(kwk::cpu, view, search, func))[0]
  ...
  {
    int search = 19;
    TTS_EQUAL(kwk::upper_bound(kwk::cpu, view, search, func), std::nullopt);
...
TTS_CASE("Check for kwk::upper_bound 1D: size = 0 with CPU context")
{
  const std::size_t input_size = 0;
  std::vector<int> input; // will not work for an std::array of size 0
  for (std::size_t i = 0; i < input_size; ++i) { input[i] = i * 3 - 20; }
...
TTS_CASE("Check for kwk::binary_search(kwk::cpu, In, value) 1D")
{
  const std::size_t input_size = 20;
  std::array<int, input_size> input;
  ...
  // Ensures that the return value is expected
  {
    bool expected = false;
    int search = -895;
    bool truth = kwk::binary_search(kwk::cpu, view, search);
...
TTS_CASE("Check for kwk::binary_search(kwk::cpu, In, value) 1D with function v1")
{
  const std::size_t input_size = 20;
  std::array<int, input_size> input;
    ...
    // Ensures that the return value is expected
  {
    bool expected = false;
    int search = -895;
    bool truth = kwk::binary_search(kwk::cpu, view, search, func);
    TTS_EQUAL(truth, expected); // Ensures that we did not make a mistake with the expected value
