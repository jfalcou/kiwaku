...
TTS_CASE("Check for kwk::lower_bound(kwk::cpu, In, value) 4D")
{
...
TTS_CASE("Check for kwk::lower_bound(kwk::cpu, In, value, func) 4D with function")
{
  const std::size_t d0 = 8;
  const std::size_t d1 = 12;
  const std::size_t d2 = 6;
...
TTS_CASE("Check for kwk::upper_bound(kwk::cpu, In, value) 4D")
{
  const std::size_t d0 = 8;
  const std::size_t d1 = 12;
  const std::size_t d2 = 6;
...
TTS_CASE("Check for kwk::upper_bound(kwk::cpu, In, value) 4D with function")
{
  const std::size_t d0 = 8;
  const std::size_t d1 = 12;
  const std::size_t d2 = 6;
...
TTS_CASE("Check for kwk::binary_search(kwk::cpu, In, value) 4D")
{
  const std::size_t d0 = 8;
  const std::size_t d1 = 12;
  const std::size_t d2 = 6;
...
TTS_CASE("Check for kwk::binary_search(kwk::cpu, In, value) 4D with function")
{
  const std::size_t d0 = 8;
  const std::size_t d1 = 12;
  const std::size_t d2 = 6;
