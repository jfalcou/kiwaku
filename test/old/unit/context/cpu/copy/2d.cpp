...
TTS_CASE("Check for kwk::copy(kwk::cpu, out, in) 2D")
{
...
TTS_CASE("Check for kwk::copy(kwk::cpu, out, in) 2D with double")
{
  const std::size_t d0 = 12;
  const std::size_t d1 = 70;
  const std::size_t input_size = d0 * d1;
...
TTS_CASE("Check for kwk::copy_if(kwk::cpu, func, out, in) 2D")
{
  const std::size_t d0 = 12;
  const std::size_t d1 = 70;
  const std::size_t input_size = d0 * d1;
