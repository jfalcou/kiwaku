...
TTS_CASE("Check for kwk::copy(kwk::cpu, out, in) 4D")
{
  const std::size_t d0 = 12;
  const std::size_t d1 = 70;
  const std::size_t d2 = 8;
  const std::size_t d3 = 18;
...
TTS_CASE("Check for kwk::copy(kwk::cpu, out, in) 4D with double")
{
...
TTS_CASE("Check for kwk::copy_if(kwk::cpu, func, out, in) 4D")
{
  const std::size_t d0 = 12;
  const std::size_t d1 = 70;
  const std::size_t d2 = 8;
