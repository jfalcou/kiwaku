...
TTS_CASE("Check for kwk::transform_reduce(kwk::cpu, In1, In2, init, Reduce, Transform) 2D")
{
  float init_value = 11;
  ...
  auto res = kwk::transform_reduce(kwk::cpu, view1, view2, init_value
                                    // Reduce function
...
TTS_CASE("Check for kwk::transform_reduce(kwk::cpu, In1, In2, init, Transform) 2D")
{
...
TTS_CASE("Check for kwk::transform_reduce(kwk::cpu, In1, In2) 2D")
{
  double init_value = 11;
  const std::size_t d0 = 50;
  const std::size_t d1 = 12;
...
TTS_CASE("Check for kwk::inner_product(kwk::cpu, In1, In2, value, sum, product) 2D")
{
  float init_value = 87;
  const std::size_t d0 = 50;
  const std::size_t d1 = 12;
  ...
  auto res = kwk::inner_product(kwk::cpu, view1, view2, init_value,
            [](auto r, auto d) { return (r + d); },
            [](auto i1, auto i2) { return (i1 * i2); }
            );
...
TTS_CASE("Check for kwk::inner_product(kwk::cpu, In1, In2, init) 2D")
{
...
TTS_CASE("Check for kwk::inner_product(kwk::cpu, In1, In2) 2D")
{
  const std::size_t d0 = 50;
  const std::size_t d1 = 12;
  const std::size_t input_size = d0 * d1;
  ...
  auto res = kwk::inner_product(kwk::cpu, view1, view2);
...
TTS_CASE("Check for kwk::transform_exclusive_scan(kwk::cpu, In, Out, init, f1, f2) 2D")
{
  ...
  kwk::transform_exclusive_scan ( kwk::cpu
                                , view_in, view_out
                                , init_value
                                , [](auto r, auto d){ return (r / d); }
                                , [](auto i1){ return (i1 * 2); }
...
TTS_CASE("Check for kwk::transform_inclusive_scan(kwk::cpu, In, Out, init, f1, f2) 2D")
{
  double init_value = 0;
  const std::size_t d0 = 50;
  const std::size_t d1 = 12;
  ...
  kwk::transform_inclusive_scan ( kwk::cpu
                                , view_in, view_out
                                , init_value
                                , [](auto r, auto d){ return (r / d); }
                                , [](auto i1){ return (i1 * 2); }
...
TTS_CASE("Check for kwk::exclusive_scan(kwk::cpu, kwk::cpu, In, Out, init, func) 2D")
{
...
TTS_CASE("Check for kwk::exclusive_scan(kwk::cpu, In, Out, init) 2D")
{
  int initial_value = 0;
  const std::size_t d0 = 50;
  const std::size_t d1 = 12;
  ...
  kwk::exclusive_scan(kwk::cpu, view_in, view_out, initial_value);
...
TTS_CASE("Check for kwk::inclusive_scan(kwk::cpu, In, Out, init, func) 2D")
{
  const std::size_t d0 = 50;
  const std::size_t d1 = 12;
  const std::size_t input_size = d0 * d1;
  ...
  kwk::inclusive_scan(kwk::cpu, view_in, view_out, float{0}, [](auto r, auto d){ return r + d * 0.2452f; });
...
TTS_CASE("Check for kwk::inclusive_scan(kwk::cpu, In, Out, init) 2D")
{
  const std::size_t d0 = 50;
  const std::size_t d1 = 12;
  const std::size_t input_size = d0 * d1;
  ...
  kwk::inclusive_scan(kwk::cpu, view_in, view_out, int{0});
  std::inclusive_scan(input.begin(), input.end(), output_std.begin());
