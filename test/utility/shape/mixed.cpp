...
TTS_CASE( "2D partial shape constructor" )
{
  ...
  TTS_EQUAL(get<0>(s5)          , 7U  );
  TTS_EQUAL(get<1>(s5)          , 9U  );
};
...
TTS_CASE( "3D partial shape constructor" )
{
  ...
  TTS_EQUAL(get<0>(s6)          , 7U  );
  TTS_EQUAL(get<1>(s6)          , 9U  );
  ...
  TTS_EQUAL(get<1>(s7)          , 9U  );
  TTS_EQUAL(get<2>(s7)          , 11U );
  ...
  TTS_EQUAL(get<0>(s8)          , 7U  );
  TTS_EQUAL(get<1>(s8)          , 9   );
  TTS_EQUAL(get<2>(s8)          , 11U );
  ...
  TTS_EQUAL(get<0>(s9)          , 7U  );
  TTS_EQUAL(get<1>(s9)          , 9U  );
  TTS_EQUAL(get<2>(s9)          , 11U );
};
