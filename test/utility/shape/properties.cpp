...
TTS_CASE( "numel behavior on nD shape" )
{
  ...
  TTS_EXPR_IS( kwk::of_size<std::uint32_t>(4,2,6,9).numel() , int);
  TTS_EXPR_IS( kwk::of_size<std::ptrdiff_t>(4,2,6,9).numel(), int);
  TTS_EXPR_IS( kwk::of_size<std::size_t>(4,2,6,9).numel()   , int);
