...
TTS_CASE( "Automatic storage, constexpr 4D shape array - Basic properties" )
{
  kwk::array<float,kwk::extent[3][5][7][2]> a;
...
{
  kwk::array<float,kwk::extent[3][5][7][2]> ref;
...
{
  kwk::array<float,kwk::extent[3][5][7][2]> ref, ref2;
...
TTS_CASE( "Automatic storage, constexpr 4D shape array - Move constructor" )
{
  kwk::array<float,kwk::extent[3][5][7][2]> a, ref, ref2;
