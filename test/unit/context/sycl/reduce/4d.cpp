...
TTS_CASE("Check for kwk::reduce(kwk::sycl::default_context, in) 4D")
{
  using data_type = int;
...
TTS_CASE("Check for kwk::reduce(kwk::sycl::default_context, in, func) and kwk::reduce(kwk::sycl::default_context, in, func, init) 4D")
{
  using data_type = int;
  const std::size_t d0 = 471;
  const std::size_t d1 = 11;
