...
TTS_CASE("Shape behavior - Mixed 1D")
{
  ...
  TTS_EQUAL(shape_d.ndim, 1);
  TTS_EQUAL(shape_s.ndim, 1);
  TTS_EQUAL(shape_di.ndim, 1);
...
TTS_AND_THEN("Attributes of default constructed shapes")
{
  ...
  TTS_EQUAL(shape_dd.ndim, 2L);
  TTS_EQUAL(shape_ds.ndim, 2L);
  TTS_EQUAL(shape_sd.ndim, 2L);
  TTS_EQUAL(shape_ss.ndim, 2L);
}
...
TTS_CASE("Default constructed shape behavior - Mixed 3D")
{
  ...
  TTS_EQUAL(shape_ddd.ndim, 3L);
  TTS_EQUAL(shape_dds.ndim, 3L);
  TTS_EQUAL(shape_dsd.ndim, 3L);
  TTS_EQUAL(shape_dss.ndim, 3L);
  TTS_EQUAL(shape_sdd.ndim, 3L);
  TTS_EQUAL(shape_sds.ndim, 3L);
  TTS_EQUAL(shape_ssd.ndim, 3L);
  TTS_EQUAL(shape_sss.ndim, 3L);
};
...
TTS_CASE("Default constructed shape behavior - Mixed 4D")
{
  ...
  TTS_EQUAL(shape_dddd.ndim, 4L);
  TTS_EQUAL(shape_ddds.ndim, 4L);
  TTS_EQUAL(shape_ddsd.ndim, 4L);
  TTS_EQUAL(shape_ddss.ndim, 4L);
  TTS_EQUAL(shape_dsdd.ndim, 4L);
  TTS_EQUAL(shape_dsds.ndim, 4L);
  TTS_EQUAL(shape_dssd.ndim, 4L);
  TTS_EQUAL(shape_dsss.ndim, 4L);
  TTS_EQUAL(shape_sddd.ndim, 4L);
  TTS_EQUAL(shape_sdds.ndim, 4L);
  TTS_EQUAL(shape_sdsd.ndim, 4L);
  TTS_EQUAL(shape_sdss.ndim, 4L);
  TTS_EQUAL(shape_ssdd.ndim, 4L);
  TTS_EQUAL(shape_ssds.ndim, 4L);
  TTS_EQUAL(shape_sssd.ndim, 4L);
  TTS_EQUAL(shape_ssss.ndim, 4L);
};
