...
TTS_CASE("Check for kwk::fill(kwk::cpu, container, value) 2D")
{
  using data_type = int;
...
TTS_CASE("Check for kwk::generate(kwk::cpu, func, container) 2D")
{
  using data_type = int;
  const std::size_t d0 = 6;
  ...
  std::size_t count = 0;
  kwk::generate (kwk::cpu, [&](auto i0, auto i1) { 
                    count++;
                    return i0 * 100 + i1; 
                  }
                , view
...
TTS_CASE("Check for kwk::iota(kwk::cpu, out) 2D")
{
  using data_type = int;
  const std::size_t d0 = 6;
...
TTS_CASE("Check for kwk::iota(kwk::cpu, out, value) 2D")
{
  using data_type = int;
  const std::size_t d0 = 6;
  const std::size_t d1 = 8;
...
TTS_CASE("Check for kwk::iota(kwk::cpu, out, value, step) 2D")
{
  using data_type = int;
  const std::size_t d0 = 6;
  const std::size_t d1 = 8;
