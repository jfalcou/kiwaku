...
// TTS_CASE("Check for kwk::inner_product(kwk::sycl::default_context, In1, In2, value, sum, product) 1D")
// {
//   float init_value = 87;
...
// TTS_CASE("Check for kwk::inner_product(kwk::sycl::default_context, In1, In2, init) 1D")
// {
...
// TTS_CASE("Check for kwk::inner_product(kwk::sycl::default_context, In1, In2) 1D")
// {
//   const std::size_t d0 = 2784;
//   const std::size_t input_size = d0;
//   std::array<int, input_size> input1;
...
// TTS_CASE("Check for kwk::transform_exclusive_scan(kwk::sycl::default_context, In, Out, init, f1, f2) 1D")
// {
...
// TTS_CASE("Check for kwk::transform_inclusive_scan(kwk::sycl::default_context, In, Out, init, f1, f2) 1D")
// {
//   double init_value = 0;
...
// TTS_CASE("Check for kwk::exclusive_scan(kwk::sycl::default_context, In, Out, init, func) 1D")
// {
...
// TTS_CASE("Check for kwk::exclusive_scan(kwk::sycl::default_context, In, Out, init) 1D")
// {
//   int initial_value = 0;
...
// TTS_CASE("Check for kwk::inclusive_scan(kwk::sycl::default_context, In, Out, init, func) 1D")
// {
...
// TTS_CASE("Check for kwk::inclusive_scan(kwk::sycl::default_context, In, Out, init) 1D")
// {
//   const std::size_t d0 = 471;
//   const std::size_t input_size = d0;
