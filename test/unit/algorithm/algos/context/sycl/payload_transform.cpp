...
TTS_CASE("Check for kwk::transform(kwk::sycl::default_context, value, new_value) 1D")
{
  ...
  auto fct = [&](auto& payload_out, auto& payload_in1, auto& payload_in2)
  {
    kwk::transform( kwk::sycl::default_context
  ...
  kwk::with ( kwk::sycl::default_context
            , fct
            , kwk::payload::out{view_out}
            , kwk::payload::in{view_in1}
            , kwk::payload::in{view_in2}
            );
