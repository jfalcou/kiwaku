...
namespace kwk
{
  ...
  //! @return A pointer to the newly allocated memory. If zero byte was requested,
  //! the returned
  ...
  //!
  //! Free the heap memory from a pointer. If the deallocated memory was not
  //! allocated by an instance of kwk::heap_allocator, the behavior is undefined.
  //!
