...
void run()
{
  ...
  auto kwkVA = kwk::table{kwk::source = Va, kwk::of_size(ARRAY_SIZE)};
  auto kwkVB = kwk::table{kwk::source = Vb, kwk::of_size(ARRAY_SIZE)};
  auto kwkVC = kwk::table{kwk::source = Vc, kwk::of_size(ARRAY_SIZE)};

  auto kwkMA = kwk::table{kwk::source = Ma, kwk::of_size(ARRAY_SIZE,ARRAY_SIZE)};
  auto kwkMB = kwk::table{kwk::source = Mb, kwk::of_size(ARRAY_SIZE,ARRAY_SIZE)};
  auto kwkMC = kwk::table{kwk::source = Mc, kwk::of_size(ARRAY_SIZE,ARRAY_SIZE)};
